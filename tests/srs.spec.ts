 ...
 * The scheduler.
 *
 * Carried over from the CLI's suite, because the scheduler is the thing
 * claudelingo actually is and none of it changed when the surface did. If this
 * file had gone with the CLI, the most load-bearing code in the repo would have
 * lost every test it had.
 */
...
import type { ItemProgress, Progress } from "../hooks/types";
import { DAY, MINUTE, T0, testPack, testProgress, testSettings } from "./helpers";
